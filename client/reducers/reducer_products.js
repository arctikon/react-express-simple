import {
  ...
  FETCH_PRODUCTS_WITHOUT_CATEGORY, FETCH_PRODUCTS_WITHOUT_CATEGORY_SUCCESS, FETCH_PRODUCTS_WITHOUT_CATEGORY_FAILURE, RESET_PRODUCTS_WITHOUT_CATEGORY,
...
export default function(state = INITIAL_STATE, action) {
  ...
  case FETCH_PRODUCTS_WITHOUT_CATEGORY:
    return { ...state, productsList: {products:[], error: null, loading: true}}; 
  case FETCH_PRODUCTS_WITHOUT_CATEGORY_SUCCESS:
    return { ...state, productsList: {products: action.payload, error:null, loading: false} };
  case FETCH_PRODUCTS_WITHOUT_CATEGORY_FAILURE:
    error = action.payload || {message: action.payload.message};
    return { ...state, productsList: {products: [], error: error, loading: false} };
  case RESET_PRODUCTS_WITHOUT_CATEGORY:
    return { ...state, productsList: {products: [], error:null, loading: false} };
